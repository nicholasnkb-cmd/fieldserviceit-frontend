  ...
  return (
    <div className="space-y-6 p-6">
      <header className="border-b border-gray-200 pb-5">
        ...
        <h1 className="mt-2 text-3xl font-bold text-gray-950">Security and Sessions</h1>
        <p className="mt-2 text-sm text-gray-600">Protect your sign-in and remove access from devices you no longer use.</p>
      </header>
      ...
      <section className="border-b border-gray-200 pb-6">
        ...
        {setup && (
          <div className="mt-5 max-w-xl space-y-4 rounded-md border border-blue-200 bg-blue-50 p-4">
            <p className="text-sm text-blue-950">Add this key to your authenticator app, then enter the current six-digit code.</p>
            <p className="break-all rounded-md bg-white px-3 py-2 font-mono text-sm font-semibold text-gray-950">{setup.secret}</p>
