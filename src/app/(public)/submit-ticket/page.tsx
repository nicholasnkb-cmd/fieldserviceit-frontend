...
export default function SubmitTicketPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setCategory(''); setSubcategory(''); setLocation('');
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input type="text" required maxLength={191} value={title} onChange={(e) => setTitle(e.target.value)}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  ...
                  <input type="text" required maxLength={160} value={contactName} onChange={(e) => setContactName(e.target.value)}
                    className="mt-1 block w-full rounded border border-gray-300 px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
              ...
              <div>
                ...
                <input type="text" maxLength={255} value={location} onChange={(e) => setLocation(e.target.value)}
                  className="mt-1 block w-full rounded border border-gray-300 px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
